...
class QuestionResourceIT {
    ...
    private static final QuestionType DEFAULT_TYPE = QuestionType.Rating;
    private static final QuestionType UPDATED_TYPE = QuestionType.TextBox;
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getUpdatedAt()).isEqualTo(DEFAULT_UPDATED_AT);
    }
    ...
    void putNewQuestion() throws Exception {
        ...
        assertThat(testQuestion.getUpdatedAt()).isEqualTo(UPDATED_UPDATED_AT);
    }
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.title(UPDATED_TITLE).type(UPDATED_TYPE).order(UPDATED_ORDER);

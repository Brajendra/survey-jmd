...
class CampaignResourceIT {
    ...
    private static final ActorType DEFAULT_ACTOR = ActorType.Customer;
    private static final ActorType UPDATED_ACTOR = ActorType.Retailer;

    private static final EventType DEFAULT_EVENT_TYPE = EventType.Payment;
    private static final EventType UPDATED_EVENT_TYPE = EventType.Delivery;

    private static final ChannelType DEFAULT_CHANNEL = ChannelType.SMS;
    ...
    void createCampaign() throws Exception {
        ...
        assertThat(testCampaign.getActor()).isEqualTo(DEFAULT_ACTOR);
        assertThat(testCampaign.getEventType()).isEqualTo(DEFAULT_EVENT_TYPE);
    ...
    void putNewCampaign() throws Exception {
        ...
        assertThat(testCampaign.getActor()).isEqualTo(UPDATED_ACTOR);
        assertThat(testCampaign.getEventType()).isEqualTo(UPDATED_EVENT_TYPE);
    ...
    void partialUpdateCampaignWithPatch() throws Exception {
        ...
        partialUpdatedCampaign.isActive(UPDATED_IS_ACTIVE).startDate(UPDATED_START_DATE).eventType(UPDATED_EVENT_TYPE);

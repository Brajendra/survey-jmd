...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMPAIGNLINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAMPAIGNLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAMPAIGNLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAMPAIGNLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAMPAIGNLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAMPAIGNLINK actions', async () => {
      const expectedActions = [
        {

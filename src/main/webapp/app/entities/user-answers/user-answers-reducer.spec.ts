...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERANSWERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERANSWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERANSWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERANSWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERANSWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERANSWERS actions', async () => {
      const expectedActions = [
        {
